...
namespace ApiGeneratorApi.Util
{
    ...
    public class FolderWriter : IFolderWriter
    {
        ...
        {
            var s = string.Format("{0}/{5}{6}{7}-{2}{3}{4}/{1}/", WebConfigurationManager.AppSettings["OutputFolder"],
                level, DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second, DateTime.Now.Year,
